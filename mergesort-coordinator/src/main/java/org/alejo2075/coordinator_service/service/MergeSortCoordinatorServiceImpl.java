...
@Service
@Log4j2
public class MergeSortCoordinatorServiceImpl implements MergeSortCoordinatorService{
    ...
    public MergeSortCoordinatorServiceImpl(KafkaTemplate<String, String> kafkaTemplate, RedisTemplate<String, Object> redisTemplate) {
